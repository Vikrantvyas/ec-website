          ...
          {openIndex === 2 && (
            <div className="px-4 pb-4 space-y-2 text-sm">
              ...
              <div>
                ...
                {openSub === "q8" && <p className="pl-4 text-gray-600">कोर्स की कुल फीस 3000.00 रूपये हैं, जिन्‍हें आप 1000.00 रूपये प्रतिमाह जमा कर सकते हैं, यदि आप इकठ्ठा 2500.00 रूपये जमा करते हैं, तो आपको 500.00 रूपये का डिस्‍काउंट मिल जाता है यानी दो माह का इकठ्ठा जमा करने पर तीसरा माह फ्री ।</p>}
              </div>
