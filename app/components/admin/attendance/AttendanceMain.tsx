      ...
      <div className="flex-1 overflow-y-auto px-2 md:px-4 py-2 md:py-3 bg-gray-50">
        ...
        {studentsData.map((student: Student, index: number) => {
          ...
          return (
            <div
              key={student.id}
              className="py-2 md:py-3 px-2 md:px-3 bg-white rounded-lg md:rounded-xl mb-2 md:mb-3 shadow-sm relative"
            >
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="relative">
                  ...
                  {openMenuId === student.id && (
                    <div className="absolute right-0 top-6 bg-white border rounded shadow-md text-xs z-20">
