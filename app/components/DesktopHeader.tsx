    ...
    <header className="hidden md:block fixed top-0 left-0 right-0 z-40 bg-white border-b">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link href="/#courses" className="text-sm hover:text-blue-600">Courses</Link>
          <Link href="/#branches" className="text-sm hover:text-blue-600">Branches</Link>
          ...
          <div className="flex gap-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="url(#igGradDesk)">
                <defs>
                  <linearGradient id="igGradDesk" x1="0%" y1="0%" x2="100%" y2="100%">
